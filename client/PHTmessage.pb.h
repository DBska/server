...
class PHTmessage : public ::google::protobuf::Message {
 public:
  ...
  inline const ::Proposals& proposal(int index) const;
  inline ::Proposals* mutable_proposal(int index);
  inline ::Proposals* add_proposal();
  inline const ::google::protobuf::RepeatedPtrField< ::Proposals >&
      proposal() const;
  inline ::google::protobuf::RepeatedPtrField< ::Proposals >*
      mutable_proposal();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::Proposals > proposal_;

...
class TACReviews : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:TACReviews)
 private:
...
inline const ::std::string& TACReviews::comments() const {
  // @@protoc_insertion_point(field_get:TACReviews.comments)
  return *comments_;
}
inline void TACReviews::set_comments(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:TACReviews.comments)
}
inline void TACReviews::set_comments(const char* value) {
  ...
  comments_->assign(value);
  // @@protoc_insertion_point(field_set_char:TACReviews.comments)
}
inline void TACReviews::set_comments(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:TACReviews.comments)
}
inline ::std::string* TACReviews::mutable_comments() {
  ...
  // @@protoc_insertion_point(field_mutable:TACReviews.comments)
  return comments_;
}
...
inline void TACReviews::set_allocated_comments(::std::string* comments) {
  ...
  // @@protoc_insertion_point(field_set_allocated:TACReviews.comments)
}
...
inline const ::std::string& TACReviews::final_grade() const {
  // @@protoc_insertion_point(field_get:TACReviews.final_grade)
  return *final_grade_;
}
inline void TACReviews::set_final_grade(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:TACReviews.final_grade)
}
inline void TACReviews::set_final_grade(const char* value) {
  ...
  final_grade_->assign(value);
  // @@protoc_insertion_point(field_set_char:TACReviews.final_grade)
}
inline void TACReviews::set_final_grade(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:TACReviews.final_grade)
}
inline ::std::string* TACReviews::mutable_final_grade() {
  ...
  // @@protoc_insertion_point(field_mutable:TACReviews.final_grade)
  return final_grade_;
}
...
inline void TACReviews::set_allocated_final_grade(::std::string* final_grade) {
  ...
  // @@protoc_insertion_point(field_set_allocated:TACReviews.final_grade)
}
...
inline ::google::protobuf::int64 TACReviews::tac_id() const {
  // @@protoc_insertion_point(field_get:TACReviews.tac_id)
  return tac_id_;
}
inline void TACReviews::set_tac_id(::google::protobuf::int64 value) {
  set_has_tac_id();
  tac_id_ = value;
  // @@protoc_insertion_point(field_set:TACReviews.tac_id)
}

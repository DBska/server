...
ScienceGoals::ScienceGoals()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:PHT.ScienceGoals)
}
...
ScienceGoals::ScienceGoals(const ScienceGoals& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:PHT.ScienceGoals)
}
...
ScienceGoals::~ScienceGoals() {
  // @@protoc_insertion_point(destructor:PHT.ScienceGoals)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:PHT.ScienceGoals)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:PHT.ScienceGoals)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:PHT.ScienceGoals)
  return false;
#undef DO_
}
...
void ScienceGoals::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:PHT.ScienceGoals)
  // optional double frequence = 1;
  if (has_frequence()) {
  ...
  // @@protoc_insertion_point(serialize_end:PHT.ScienceGoals)
}

::google::protobuf::uint8* ScienceGoals::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:PHT.ScienceGoals)
  // optional double frequence = 1;
  if (has_frequence()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PHT.ScienceGoals)
  return target;
}

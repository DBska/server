...
TACReviews::TACReviews()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:PHT.TACReviews)
}
...
TACReviews::TACReviews(const TACReviews& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:PHT.TACReviews)
}
...
TACReviews::~TACReviews() {
  // @@protoc_insertion_point(destructor:PHT.TACReviews)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:PHT.TACReviews)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:PHT.TACReviews)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:PHT.TACReviews)
  return false;
#undef DO_
}
...
void TACReviews::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:PHT.TACReviews)
  // optional string comments = 1;
  if (has_comments()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->comments().data(), this->comments().length(),
  ...
  // @@protoc_insertion_point(serialize_end:PHT.TACReviews)
}

::google::protobuf::uint8* TACReviews::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:PHT.TACReviews)
  // optional string comments = 1;
  if (has_comments()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->comments().data(), this->comments().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PHT.TACReviews)
  return target;
}

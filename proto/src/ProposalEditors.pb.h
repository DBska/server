...
inline const ::std::string& ProposalEditors::author_id() const {
  // @@protoc_insertion_point(field_get:PHT.ProposalEditors.author_id)
  return *author_id_;
}
inline void ProposalEditors::set_author_id(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:PHT.ProposalEditors.author_id)
}
inline void ProposalEditors::set_author_id(const char* value) {
  ...
  author_id_->assign(value);
  // @@protoc_insertion_point(field_set_char:PHT.ProposalEditors.author_id)
}
inline void ProposalEditors::set_author_id(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:PHT.ProposalEditors.author_id)
}
inline ::std::string* ProposalEditors::mutable_author_id() {
  ...
  // @@protoc_insertion_point(field_mutable:PHT.ProposalEditors.author_id)
  return author_id_;
}
...
inline void ProposalEditors::set_allocated_author_id(::std::string* author_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PHT.ProposalEditors.author_id)
}
...
inline bool ProposalEditors::ispi() const {
  // @@protoc_insertion_point(field_get:PHT.ProposalEditors.isPI)
  return ispi_;
}
inline void ProposalEditors::set_ispi(bool value) {
  set_has_ispi();
  ispi_ = value;
  // @@protoc_insertion_point(field_set:PHT.ProposalEditors.isPI)
}
...
inline const ::std::string& ProposalEditors::more_info() const {
  // @@protoc_insertion_point(field_get:PHT.ProposalEditors.more_info)
  return *more_info_;
}
inline void ProposalEditors::set_more_info(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:PHT.ProposalEditors.more_info)
}
inline void ProposalEditors::set_more_info(const char* value) {
  ...
  more_info_->assign(value);
  // @@protoc_insertion_point(field_set_char:PHT.ProposalEditors.more_info)
}
inline void ProposalEditors::set_more_info(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:PHT.ProposalEditors.more_info)
}
inline ::std::string* ProposalEditors::mutable_more_info() {
  ...
  // @@protoc_insertion_point(field_mutable:PHT.ProposalEditors.more_info)
  return more_info_;
}
...
inline void ProposalEditors::set_allocated_more_info(::std::string* more_info) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PHT.ProposalEditors.more_info)
}
...
inline ::google::protobuf::int64 ProposalEditors::proposal_id() const {
  // @@protoc_insertion_point(field_get:PHT.ProposalEditors.proposal_id)
  return proposal_id_;
}
inline void ProposalEditors::set_proposal_id(::google::protobuf::int64 value) {
  set_has_proposal_id();
  proposal_id_ = value;
  // @@protoc_insertion_point(field_set:PHT.ProposalEditors.proposal_id)
}

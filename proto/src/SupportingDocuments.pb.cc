...
void protobuf_AddDesc_SupportingDocuments_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "l_justification\030\003 \001(\t", 141);
...
SupportingDocuments::SupportingDocuments()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:PHT.SupportingDocuments)
}
...
SupportingDocuments::SupportingDocuments(const SupportingDocuments& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:PHT.SupportingDocuments)
}
...
SupportingDocuments::~SupportingDocuments() {
  // @@protoc_insertion_point(destructor:PHT.SupportingDocuments)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:PHT.SupportingDocuments)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:PHT.SupportingDocuments)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:PHT.SupportingDocuments)
  return false;
#undef DO_
}
...
void SupportingDocuments::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:PHT.SupportingDocuments)
  // optional string preprints = 1;
  if (has_preprints()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->preprints().data(), this->preprints().length(),
  ...
  // @@protoc_insertion_point(serialize_end:PHT.SupportingDocuments)
}

::google::protobuf::uint8* SupportingDocuments::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:PHT.SupportingDocuments)
  // optional string preprints = 1;
  if (has_preprints()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->preprints().data(), this->preprints().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PHT.SupportingDocuments)
  return target;
}

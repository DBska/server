...
inline const ::std::string& Reviews::grade_rank() const {
  // @@protoc_insertion_point(field_get:Reviews.grade_rank)
  return *grade_rank_;
}
inline void Reviews::set_grade_rank(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Reviews.grade_rank)
}
inline void Reviews::set_grade_rank(const char* value) {
  ...
  grade_rank_->assign(value);
  // @@protoc_insertion_point(field_set_char:Reviews.grade_rank)
}
inline void Reviews::set_grade_rank(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Reviews.grade_rank)
}
inline ::std::string* Reviews::mutable_grade_rank() {
  ...
  // @@protoc_insertion_point(field_mutable:Reviews.grade_rank)
  return grade_rank_;
}
...
inline void Reviews::set_allocated_grade_rank(::std::string* grade_rank) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Reviews.grade_rank)
}
...
inline ::google::protobuf::int64 Reviews::proposal_id() const {
  // @@protoc_insertion_point(field_get:Reviews.proposal_id)
  return proposal_id_;
}
inline void Reviews::set_proposal_id(::google::protobuf::int64 value) {
  set_has_proposal_id();
  proposal_id_ = value;
  // @@protoc_insertion_point(field_set:Reviews.proposal_id)
}
...
inline const ::std::string& Reviews::review_comments() const {
  // @@protoc_insertion_point(field_get:Reviews.review_comments)
...
inline void Reviews::set_review_comments(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Reviews.review_comments)
}
inline void Reviews::set_review_comments(const char* value) {
  ...
  review_comments_->assign(value);
  // @@protoc_insertion_point(field_set_char:Reviews.review_comments)
}
inline void Reviews::set_review_comments(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Reviews.review_comments)
}
inline ::std::string* Reviews::mutable_review_comments() {
  ...
  // @@protoc_insertion_point(field_mutable:Reviews.review_comments)
  return review_comments_;
}
...
inline void Reviews::set_allocated_review_comments(::std::string* review_comments) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Reviews.review_comments)
}
...
inline ::google::protobuf::int64 Reviews::reviewer_id() const {
  // @@protoc_insertion_point(field_get:Reviews.reviewer_id)
  return reviewer_id_;
}
inline void Reviews::set_reviewer_id(::google::protobuf::int64 value) {
  set_has_reviewer_id();
  reviewer_id_ = value;
  // @@protoc_insertion_point(field_set:Reviews.reviewer_id)
}

...
inline double ScienceGoals::frequence() const {
  // @@protoc_insertion_point(field_get:PHT.ScienceGoals.frequence)
  return frequence_;
}
inline void ScienceGoals::set_frequence(double value) {
  set_has_frequence();
  frequence_ = value;
  // @@protoc_insertion_point(field_set:PHT.ScienceGoals.frequence)
}
...
inline const ::std::string& ScienceGoals::instrument_configurations() const {
  // @@protoc_insertion_point(field_get:PHT.ScienceGoals.instrument_configurations)
...
inline void ScienceGoals::set_instrument_configurations(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:PHT.ScienceGoals.instrument_configurations)
}
inline void ScienceGoals::set_instrument_configurations(const char* value) {
  ...
  instrument_configurations_->assign(value);
  // @@protoc_insertion_point(field_set_char:PHT.ScienceGoals.instrument_configurations)
}
inline void ScienceGoals::set_instrument_configurations(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:PHT.ScienceGoals.instrument_configurations)
}
inline ::std::string* ScienceGoals::mutable_instrument_configurations() {
  ...
  // @@protoc_insertion_point(field_mutable:PHT.ScienceGoals.instrument_configurations)
  return instrument_configurations_;
}
...
inline void ScienceGoals::set_allocated_instrument_configurations(::std::string* instrument_configurations) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PHT.ScienceGoals.instrument_configurations)
}
...
inline const ::std::string& ScienceGoals::more_info() const {
  // @@protoc_insertion_point(field_get:PHT.ScienceGoals.more_info)
  return *more_info_;
}
inline void ScienceGoals::set_more_info(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:PHT.ScienceGoals.more_info)
}
inline void ScienceGoals::set_more_info(const char* value) {
  ...
  more_info_->assign(value);
  // @@protoc_insertion_point(field_set_char:PHT.ScienceGoals.more_info)
}
inline void ScienceGoals::set_more_info(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:PHT.ScienceGoals.more_info)
}
inline ::std::string* ScienceGoals::mutable_more_info() {
  ...
  // @@protoc_insertion_point(field_mutable:PHT.ScienceGoals.more_info)
  return more_info_;
}
...
inline void ScienceGoals::set_allocated_more_info(::std::string* more_info) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PHT.ScienceGoals.more_info)
}
...
inline const ::std::string& ScienceGoals::target_details() const {
  // @@protoc_insertion_point(field_get:PHT.ScienceGoals.target_details)
...
inline void ScienceGoals::set_target_details(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:PHT.ScienceGoals.target_details)
}
inline void ScienceGoals::set_target_details(const char* value) {
  ...
  target_details_->assign(value);
  // @@protoc_insertion_point(field_set_char:PHT.ScienceGoals.target_details)
}
inline void ScienceGoals::set_target_details(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:PHT.ScienceGoals.target_details)
}
inline ::std::string* ScienceGoals::mutable_target_details() {
  ...
  // @@protoc_insertion_point(field_mutable:PHT.ScienceGoals.target_details)
  return target_details_;
}
...
inline void ScienceGoals::set_allocated_target_details(::std::string* target_details) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PHT.ScienceGoals.target_details)
}
